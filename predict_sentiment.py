...
# test_text = "harsh driving on Road must be avoided"
...
file_gensim = open("model_gensim_sentiment.pkl",'rb')
model_gensim = pickle.load(file_gensim)

file_model = open("model_sentiment_analysis_SVC_0.693.pkl",'rb')
